  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <h2 className="mt-4 text-xl font-semibold text-foreground">Trail not found</h2>
        <p className="mt-2 text-sm text-muted-foreground">
          This path doesn't lead anywhere — yet. Head back to base camp.
        </p>
        <div className="mt-6">
          <Link
            to="/"
    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <h1 className="font-serif text-2xl font-bold tracking-tight text-foreground">
          Something went sideways on the trail
        </h1>
        <p className="mt-2 text-sm text-muted-foreground">
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "WildMeet connects outdoor adventurers for camping, beach and mountain outings. Join a trip or host your own." },
      { property: "og:title", content: "WildMeet — Find your wild. Find your people." },
      { property: "og:description", content: "A social platform for camping, beach and mountain adventures." },
